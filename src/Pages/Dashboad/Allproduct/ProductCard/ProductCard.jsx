...
const Cardproducts = ({ product }) => {
  const { name, order, image, itemproduct, category, fingerprint, _id } =
    product;
  console.log(product);
  ...
  return (
    <div style={{ perspective: 2000 }}>
      <div
        ...
        className="card w-96 bg-base-300 shadow-2xl"
      >
        <div className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20 mx-auto bg-white">
          ...
          <div className="text-center text-black w-[85%] mx-auto font-semibold space-y-2">
            <h6 className="text-sm font-bold md:text-lg lg:text-2xl">{name}</h6>
          ...
          <div className="flex items-center justify-center flex-wrap gap-6 text-sm md:text-base">
            <button
              ...
              className="flex bg-[#0e0e2b] p-2 items-center "
            >
              <svg
                width={35}
                viewBox="0 0 24 24"
